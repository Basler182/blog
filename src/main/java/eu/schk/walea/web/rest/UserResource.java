...
import eu.schk.walea.service.MailService;
import eu.schk.walea.service.UserService;
import eu.schk.walea.service.dto.AdminUserDTO;
import eu.schk.walea.web.rest.errors.BadRequestAlertException;
import eu.schk.walea.web.rest.errors.EmailAlreadyUsedException;
import eu.schk.walea.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link eu.schk.walea.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
