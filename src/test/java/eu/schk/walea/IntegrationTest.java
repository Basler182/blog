...
import eu.schk.walea.WaleaApp;
import eu.schk.walea.config.AsyncSyncConfiguration;
import eu.schk.walea.config.EmbeddedSQL;
...
@SpringBootTest(classes = { WaleaApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
