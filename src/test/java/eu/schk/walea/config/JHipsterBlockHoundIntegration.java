...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("eu.schk.walea.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("eu.schk.walea.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
